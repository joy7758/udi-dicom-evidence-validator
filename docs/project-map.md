...
| Path | Purpose |
| --- | --- |
| `src/udi_dicom_validator/` | Public validator implementation |
| `schema/` | JSON schemas for manifest and receipt |
| `spec/` | Public manifest profile text |
| `examples/public/` | Synthetic public fixtures |
| `tests/golden/` | Deterministic receipt regression outputs |
